...
// Tight enough to only absorb genuine floating-point representation noise
// (2.00 - 1.15 is 0.8500000000000001 in IEEE 754, not exactly 0.85) — not a
// business-domain tolerance like "within a penny", which would be far too
// loose for non-currency spec-mode problems and could mask real mistakes.
...
function valuesEqual(a, b) {
  ...
  if (a && b && typeof a === 'object' && typeof b === 'object') {
    ...
    return aKeys.length === bKeys.length && aKeys.every(k => valuesEqual(a[k], b[k]));
  }
  return a === b;
}
